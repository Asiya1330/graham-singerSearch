export const FACH_OPTIONS_ADMIN = ["Soprano", "Mezzo-Soprano", "Contralto", "Countertenor", "Tenor", "Baritone", "Bass-Baritone", "Bass"];
export const VOICE_TYPE_OPTIONS_ADMIN = ["Soprano", "Mezzo-Soprano", "Contralto", "Countertenor", "Tenor", "Baritone", "Bass-Baritone", "Bass"];
