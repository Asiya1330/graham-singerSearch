      ...
      <div className="max-w-2xl mx-auto px-4 py-10 space-y-8">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setProfile((p) => ({ ...p, organization_name: e.target.value }))
              }
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setProfile((p) => ({ ...p, organization_type: e.target.value }))
              }
              className="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-4">
          ...
          <div>
            ...
            <PasswordInput
              data-testid="input-org-current-password"
              value={pw.current}
              onChange={(e) =>
          ...
          <div>
            ...
            <PasswordInput
              data-testid="input-org-new-password"
              value={pw.next}
          ...
          <button
            data-testid="button-org-change-password"
